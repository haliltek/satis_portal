                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Ürün Listesi Excel Toplu Yükleme <a href="urunler.xlsx" class="btn btn-success" download> EXCEL ŞABLONU İNDİRİN </a> </h4>
                                    <div class='maindiv'>
                                        <br>
                                        <div id="barDiv"></div>
                                        <form action="iskontoupload.php" id="formID" name="frmupload" method="post" enctype="multipart/form-data">
