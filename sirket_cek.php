...
try {
    $mssql_dsn = "sqlsrv:Server=$mssql_hostname;Database=$mssql_dbname;TrustServerCertificate=yes;LoginTimeout=5";
    ...
    $mssql_dsn_gemas = "sqlsrv:Server=$mssql_hostname;Database=$mssql_dbname_gemas;TrustServerCertificate=yes;LoginTimeout=5";
