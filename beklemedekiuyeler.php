...
<body data-layout="horizontal" data-topbar="colored">
                        ...
                        <div class="col-lg-12">
                            ...
                            if (isset($_POST['duzenleme'])) {
                                ...
                                if ($duzenleme) {
                                    ...
                                    echo '<meta http-equiv="refresh" content="2; url=beklemedekiuyeler.php"> ';
                                } else {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4"><b>Henüz Üyeliği Onaylanmamış</b> Şirket Personel Başvuruları</h4>
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-bordered table-responsive nsowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $personel_sorgulama = mysqli_query($db, "SELECT * FROM  personel where p_durum='Beklemede' or p_durum='Yönetici Onayında'");
                                                ...
                                                if ($dur == 'Red') {
                                                            ...
                                                            <a href="bekleyensirketpersonelsil.php?id=<?php echo $personel["personel_id"]; ?>" class="btn btn-danger waves-effect waves-light btn-sm"> Sistemden Sil </a>
                                                        </td>
                                                        <td><?php echo $i; ?></td>
    ...
    <?php
    $sirket_sorgulama = mysqli_query($db, "SELECT * FROM  personel where p_durum='Beklemede'");
        ...
        <div class="modal fade duzenle<?php echo $sirket["personel_id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form method="post" action="beklemedekiuyeler.php" class="needs-validation" novalidate>
                        <div class="modal-body">
                            <div class="p-2 mt-2">
                                <form action="beklemedekiuyeler.php" method="post">
                                    <div class="row">
