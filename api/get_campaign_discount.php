...
try {
    ...
    $dsn = "sqlsrv:Server={$logo['host']};Database={$logo['db']};TrustServerCertificate=yes;LoginTimeout=5";
    $options = [
    ...
    $dsnTiger = "sqlsrv:Server={$logo['host']};Database=Tiger;TrustServerCertificate=yes;LoginTimeout=5";
