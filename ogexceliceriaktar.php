        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <a type="button" class="btn btn-success waves-effect waves-light float-right"
                                href="og.php">Manuel OG Tanımlayınız</a>
                            ...
                            <a type="button" class="btn btn-danger waves-effect waves-light float-right"
                                href="ogtumunusil.php">Tüm Verileri Sistemden Sil</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">OG Listesi Excel Toplu Yükleme <?php
                                    ...
                                    <div class='maindiv'>
                                        <br>
                                        <div id="barDiv"></div>
                                        <form action="upload.php" id="formID" name="frmupload" method="post"
                                            enctype="multipart/form-data">
                                            <input type="hidden"
                                                name="MAX_FILE_SIZE" /><!--byte olarak (mutlaka input type="file" den önce olmalıdır)-->
                                            <input type="file" name="file[]" /><br>
                                            <br>
                                            <input type="submit" name="submit_file" value="Yüklemeyi Başlat"
                                                onclick="Yukleme_Goster('formID', 'barDiv', 'dairesel', '#22466E', 250, 250);" />
                                        </form>
