...
@section('title', 'B2B Admin Panel - Banka Düzenle')
@section('content')
    <!-- ============================================================== -->
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">Banka Düzenle
                            <a class="btn btn-danger float-right" href="{{url('panel/bankalar')}}">Geri</a>
                        </div>
                        <div class="card-body">

                            <div data-repeater-list="group-a">
                                <form action="{{url('panel/bankaduzenlepost')}}/{{$id}}" method="post">
                                    @csrf
                                    <div data-repeater-item class="row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" id="name" name="sube" value="{{$sube}}" class="form-control" placeholder="" />
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="name">Hesap No</label>
                                            <input type="text" id="name" name="hesapno" value="{{$hesapno}}" class="form-control" placeholder="" />
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="name">İban No</label>
                                            <input type="text" id="name" name="iban" value="{{$iban}}" class="form-control" placeholder="" />
                                        </div>
