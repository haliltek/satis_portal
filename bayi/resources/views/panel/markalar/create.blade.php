...
@section('title', 'B2B Admin Panel - Model Ekle')
@section('content')
<!-- ============================================================== -->
...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">Marka Ekle
                        <a class="btn btn-danger float-right" href="{{url('panel/markalar')}}">Geri</a>
                    </div>
                    <div class="card-body">

                        <div data-repeater-list="group-a">
                            <form action="{{url('panel/markaeklepost')}}" method="post">
                             @csrf
                            <div data-repeater-item class="row">
                                <div class="form-group col-lg-10">
                                    <label for="name">Marka Adı</label>
                                    <input type="text" id="marka" name="marka" class="form-control" placeholder="" />
                                </div>
