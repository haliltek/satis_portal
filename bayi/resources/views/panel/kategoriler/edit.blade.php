...
@section('title', 'B2B Admin Panel - Kategori Düzenle')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">Kategori Düzenle</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-0 row" id="katalan">
                                            <div class="form-group col-lg-3">
                                                <label for="name">Üst Kategori Seç (Kategorileri Değişmeyecekseniz Boş Bırakın)</label>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" id="name" value="{{$katadi}}" name="kategori" class="form-control" placeholder="" />
                                        </div>
