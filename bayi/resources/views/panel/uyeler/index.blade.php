                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('panel/adminduzenle/')}}/{{$admin->id}}" alt="Düzenle"><i class="fa fa-edit"></i></a>
                                        <a href="{{url('panel/adminsil/')}}/{{$admin->id}}" alt="Sil" class="alert"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
