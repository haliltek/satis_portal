...
@section('title', 'B2B Admin Panel - Birim Düzenle')
@section('content')
    <!-- ============================================================== -->
    ...
    <div class="main-content">
        ...
        <div class="page-content">
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Birim Ayarları</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">Birim Düzenle
                            <a class="btn btn-danger float-right" href="{{url('panel/birimler')}}">Geri</a>
                        </div>
                        <div class="card-body">

                            <div data-repeater-list="group-a">
                                <form action="{{url('panel/birimduzenlepost')}}/{{$id}}" method="post">
                                    @csrf
