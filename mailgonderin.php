                  ...
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-md-12"> <!-- 4 Sütun Ortaladık Başlangıcı -->
                        <form action="mailgonderin.php" method="post"> <!-- Form Başlangıcı -->
                          <div class="form-group"> <!-- Ad Soyad Text Alanı -->
                            ...
                            <input required="required" name="AdiSoyadi" type="text" class="form-control"
                              placeholder="müşterinizin adı ve soyadınızı ">

                          </div> <!-- Ad Soyad Text Alanı Bitti -->
                          <br>
                          <div class="form-group"> <!-- Mail Adresi Text Alanı -->
                            <small class="form-text text-muted">Lütfen gönderilecek mail adresini girin.</small>
                            <input required="required" name="MailAdresi" type="email" class="form-control"
                              placeholder="Müşteri E-Posta Adresiniz">
  ...
  <center style='background-color:#E1E1E1;'>
    ...
    ";
              ...
              if ($mail->Send()) {
                ...
                echo '<script>document.location="mailgonderin.php"</script>';
              } else {
